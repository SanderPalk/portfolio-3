        ...
        <div className="App">
            <header>
                ...
                <nav>
                    {navLinks.map((link, index) => (
                        <a href={`#${link.toLowerCase()}`}><span>({index})</span> {link}</a>
                    ))}
                </nav>
            </header>
            ...
            <section className="introduction">
                <div>
                    ...
                    <p><span>I'm</span> a 24-year-old software developer with a specialization
                        in <span>web development</span>. I also love to be physically active and
                        I'm <span>always</span> ready to take on
                        new challenges.<br />
                    </p>
            ...
            <section id="about" className="about">
                ...
                <div className="section-body-wrapper">
                    <div className="section-body-text">
                        <p>
                            For <span>two years</span>, I've been an integral part of a professional software
                            development team, where I've contributed to the creation of large-scale projects, but also
                            leading the final development stages of project.
                            <br /><br />
                            In addition to my team contributions, I've also been involved in a variety
                            of <span>e-commerce</span> solutions, ranging from smaller to more substantial projects, all
                            built on the
                            foundation of <span>WordPress WooCommerce</span>.
                            <br /><br />
                            I'm dedicated to delivering <span>high-quality</span> software solutions and continuously expanding my
                            knowledge in the dynamic field of web development.
                        </p>

                        <p>
                            My personal preferred technologies
                            are <span>React</span>, <span>NodeJS</span>, <span>PostgreSQL</span> <span>MongoDB</span> and <span>MySql</span> / <span>MariaDb</span>. <br /><br />
            ...
            <section id="work">
                <div>
                    <div className="section-heading-wrapper">
                        <h1><span>(2)</span> Demo projects </h1>
                        <hr />
                    </div>
                </div>
                <span className="disclaimer">These projects are older and don't represent my current skill-set</span>
                ...
                <div>
                    ...
                    <div className="section-contact-wrapper">
                        ...
                        <ul>
                            ...
                            <li><a href="https://www.linkedin.com/in/sander-palk-a45391268/"><img src={linkedIn}
